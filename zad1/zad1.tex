...
\begin{document}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth, height=7cm]{math.jpg}
		\caption{Math}
		\label{fig: Math}
	\end{figure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=9cm, height=6cm]{math2.jpg}
		\caption{Math2}
		\label{fig: Math2}
	\end{figure}
	...
	\begin{thebibliography}{10}
		\bibitem{Lorem}, ``Lorem Ipsum," \emph{Etiam sagittis vitae purus et congue}, pp. 473-480, February 2 1998.
		\bibitem{Dolor}``Dolor Es," \emph{Sentiam vitae purus et hingue}, pp. 720, January 1 1999.
	\end{thebibliography}
